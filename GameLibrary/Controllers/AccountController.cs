...
using GameLibrary.Models.AccountViewModels;
...
namespace GameLibrary.Controllers
{
    ...
    public class AccountController : GameLibController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> UserDelete([FromForm]string userId)
        {
            if (userId == null)
                return NotFound();
